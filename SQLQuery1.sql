...
-- COMPLETED ORDERS
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-001') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-001',u.id,c.id,499000,'VNPAY','COMPLETED','DEMO-TXN-001',DATEADD(day,-12,SYSDATETIME()),DATEADD(day,-12,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student@gmail.com' AND c.title=N'Tiếng Anh Giao Tiếp Thực Chiến Cho Người Đi Làm' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-002') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-002',u.id,c.id,890000,'MOMO','COMPLETED','DEMO-TXN-002',DATEADD(day,-10,SYSDATETIME()),DATEADD(day,-10,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student@gmail.com' AND c.title=N'Chinh Phục IELTS 7.0+ Toàn Diện 4 Kỹ Năng' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-003') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-003',u.id,c.id,499000,'BANK_TRANSFER','COMPLETED','DEMO-TXN-003',DATEADD(day,-8,SYSDATETIME()),DATEADD(day,-8,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student2@gmail.com' AND c.title=N'Tiếng Anh Giao Tiếp Thực Chiến Cho Người Đi Làm' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-004') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-004',u.id,c.id,890000,'VNPAY','COMPLETED','DEMO-TXN-004',DATEADD(day,-6,SYSDATETIME()),DATEADD(day,-6,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student2@gmail.com' AND c.title=N'Chinh Phục IELTS 7.0+ Toàn Diện 4 Kỹ Năng' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-005') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-005',u.id,c.id,350000,'MOMO','COMPLETED','DEMO-TXN-005',DATEADD(day,-5,SYSDATETIME()),DATEADD(day,-5,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student2@gmail.com' AND c.title=N'Bứt Phá TOEIC 750+ Cấp Tốc Trong 30 Ngày' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-006') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-006',u.id,c.id,499000,'VNPAY','COMPLETED','DEMO-TXN-006',DATEADD(day,-7,SYSDATETIME()),DATEADD(day,-7,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student3@gmail.com' AND c.title=N'Tiếng Anh Giao Tiếp Thực Chiến Cho Người Đi Làm' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-007') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-007',u.id,c.id,350000,'BANK_TRANSFER','COMPLETED','DEMO-TXN-007',DATEADD(day,-4,SYSDATETIME()),DATEADD(day,-4,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student3@gmail.com' AND c.title=N'Bứt Phá TOEIC 750+ Cấp Tốc Trong 30 Ngày' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-008') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-008',u.id,c.id,550000,'MOMO','COMPLETED','DEMO-TXN-008',DATEADD(day,-2,SYSDATETIME()),DATEADD(day,-2,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student3@gmail.com' AND c.title=N'Tiếng Anh Chuyên Ngành CNTT (IT English)' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-009') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-009',u.id,c.id,890000,'VNPAY','COMPLETED','DEMO-TXN-009',DATEADD(day,-9,SYSDATETIME()),DATEADD(day,-9,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student4@gmail.com' AND c.title=N'Chinh Phục IELTS 7.0+ Toàn Diện 4 Kỹ Năng' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-010') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-010',u.id,c.id,550000,'MOMO','COMPLETED','DEMO-TXN-010',DATEADD(day,-3,SYSDATETIME()),DATEADD(day,-3,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student4@gmail.com' AND c.title=N'Tiếng Anh Chuyên Ngành CNTT (IT English)' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-011') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-011',u.id,c.id,299000,'BANK_TRANSFER','COMPLETED','DEMO-TXN-011',DATEADD(day,-1,SYSDATETIME()),DATEADD(day,-1,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student4@gmail.com' AND c.title=N'Ngữ Pháp Tiếng Anh Nền Tảng A-Z' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-012') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-012',u.id,c.id,499000,'VNPAY','COMPLETED','DEMO-TXN-012',DATEADD(day,-11,SYSDATETIME()),DATEADD(day,-11,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student5@gmail.com' AND c.title=N'Tiếng Anh Giao Tiếp Thực Chiến Cho Người Đi Làm' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-013') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-013',u.id,c.id,350000,'MOMO','COMPLETED','DEMO-TXN-013',DATEADD(day,-6,SYSDATETIME()),DATEADD(day,-6,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student5@gmail.com' AND c.title=N'Bứt Phá TOEIC 750+ Cấp Tốc Trong 30 Ngày' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
IF NOT EXISTS (SELECT 1 FROM orders WHERE order_code='DEMO-014') INSERT INTO orders(order_code,student_id,course_id,amount,payment_method,status,transaction_no,created_at,completed_at) SELECT 'DEMO-014',u.id,c.id,299000,'BANK_TRANSFER','COMPLETED','DEMO-TXN-014',DATEADD(day,-2,SYSDATETIME()),DATEADD(day,-2,SYSDATETIME()) FROM users u CROSS JOIN courses c WHERE u.email='student5@gmail.com' AND c.title=N'Ngữ Pháp Tiếng Anh Nền Tảng A-Z' AND NOT EXISTS (SELECT 1 FROM orders o WHERE o.student_id=u.id AND o.course_id=c.id AND o.status='COMPLETED');
