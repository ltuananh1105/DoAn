    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter) throws Exception {
        return http.csrf(csrf -> csrf.disable()).cors(cors -> {})
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/users/*/status", "/api/users/*/reset-password").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/courses").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/users/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/courses/*/approve", "/api/courses/*/reject",
                                "/api/courses/*/suspend", "/api/courses/*/restore").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/courses/*/archive").hasAnyRole("ADMIN", "TEACHER")
